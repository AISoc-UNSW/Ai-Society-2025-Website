...
app.include_router(
    portfolios_router, prefix=f"{settings.API_V1_STR}/portfolios", tags=["Portfolios"]
)
app.include_router(tasks_router, prefix=f"{settings.API_V1_STR}/tasks", tags=["Tasks"])
app.include_router(
    meeting_records_router,
    prefix=f"{settings.API_V1_STR}/meeting-records",
    tags=["Meeting Records"],
)
app.include_router(
    task_assignments_router,
    prefix=f"{settings.API_V1_STR}/task-assignments",
